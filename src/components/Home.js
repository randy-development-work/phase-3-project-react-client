...
function Home() {
  return(
      <section className='home-p'>
        ...
        <div backgroundSize="cover" backgroundPosition="centre" >
            ...
            <img className ="backVideo"   bac style={{ width: '100%', height: '100%' }} src = "https://images.unsplash.com/photo-1603827457577-609e6f42a45e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGRvbmF0aW9ufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60">
